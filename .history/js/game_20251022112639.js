...
grid.addEventListener('click', function (event) {
  // La cible de l'événement est notre élément cliqué
...
if (cliked.nodeName === 'SECTION') { 
  return;
}
// Ajouter la classe sélectionnée
cliked.classList.add('selected');
}); // Chaque div sélectionné aura une bordure bleue, telle que définie par le CSS sélectionné.
